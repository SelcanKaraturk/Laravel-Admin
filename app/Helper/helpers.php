...
if (!function_exists('clearLogs')) {
    function clearLogs()
    {
        ...
        $dir = base_path() . '/storage/debugbar'; //ana dizinin yolunu getirir.
        foreach (glob($dir . '/*') as $file) { // bir path deki tüm dosyaları getirmek için.
...
if (!function_exists('String')) {
    function String($string,$length)
    {
        ...
        $text = str_replace($lastText,' ...',$text); //text içerisinde d... biten kelimeyi silip yerine ... yazdık
        return $text;
    }
}
